...
// LinkedList :- 1->2->3->4->6->Null
//Step 1:- Find list size
//Step 2:- Dist. from last is (Size-n+1) = nth Node from last that we want to delete
//step 3:- Dfs Prev = (Size-n)
//Step 4:- Prev.next = prev.next.next
